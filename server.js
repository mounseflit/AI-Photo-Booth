...
app.post('/api/send-email', async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      to: to,
      subject: "Your Magic Face Transformation! ✨",
      html: `<!DOCTYPE html>
...
<head>
  ...
  <title>Your Transformation</title>
  <!--[if mso]>
  <xml>
...
<body style="margin:0; padding:0; background:#f5f7fb;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; opacity:0; mso-hide:all;">
    Your image is ready—view or download your transformation.
  </div>
          ...
          <tr>
            <td class="p-24" style="padding:28px 24px 8px 24px; text-align:center;">
              ...
              <h2 style="margin:0 0 10px 0; font-family:Arial,Helvetica,sans-serif; font-size:22px; line-height:1.3; color:#1f2937;">
                ✨Check out your amazing transformation!✨
              </h2>
              <p style="margin:0; font-family:Arial,Helvetica,sans-serif; font-size:14px; line-height:1.6; color:#4b5563;">
                We’ve generated something special for you. Preview it below and download in one click.
              </p>
            </td>
          </tr>
            ...
            <td style="padding:18px 24px 0 24px;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:8px;">
                <tr>
                  <td style="border:3px solid #f4c430; border-radius:16px; box-shadow:0 0 0 4px rgba(244,196,48,0.12), 0 10px 22px rgba(17,24,39,0.08); padding:10px;">
                    <img src="cid:transformation@aicrafters" alt="Your generated transformation" width="552" style="display:block; width:100%; height:auto; border-radius:12px; border:1px solid #f1f5f9;">
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top:8px;">
                <tr>
                  ...
                  <td align="center" style="font-size:12px; color:#9ca3af; font-family:Arial,Helvetica,sans-serif;">Created by AI Magical Photo Booth ✨</td>
